...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataservice) {
        ...
        this.title = 'aws-s3-ng try it now';
        this.todos = [];
        this.generics = [];
    ...
    AppComponent.prototype.get_my_todo = function () {
        var _this = this;
        console.log('inside my to dos');
        this.dataservice.get_todo().subscribe(function (res) {
            _this.todos = res;
        });
        return this.todos;
    };
    ...
    AppComponent.prototype.get_my_generic = function () {
        var _this = this;
        console.log('inside my generic api');
        this.dataservice.get_generic().subscribe(function (res) {
            _this.generics = res;
        });
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _stock_stock_component__WEBPACK_IMPORTED_MODULE_5__["StockComponent"]
            ],
            imports: [
...
var DataService = /** @class */ (function () {
    function DataService(httpClient) {
        ...
        this.todoApi = 'https://jsonplaceholder.typicode.com/todos';
        this.genericApi = 'http://localhost:3000/generics';
    }
    ///get_todo()
    // will get a list of todos from mock server
    DataService.prototype.get_todo = function () {
    ...
    DataService.prototype.get_generic = function () {
        return this.httpClient.get("" + this.genericApi);
    };
...
module.exports = __webpack_require__(/*! /mnt/rnd/workspace/aws_s3_ng/src/main.ts */"./src/main.ts");
